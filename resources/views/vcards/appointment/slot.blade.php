        ...
        <div class="align-items-center justify-content-between mt-md-0 mt-10 timeSlot">
            <div class="d-flex align-items-center mb-3 add-slot">
                ...
                <div class="d-inline-block">
                    {{ Form::select('startTimes['.$day.'][]', getSchedulesTimingSlot(),  $times['start_time'],['class' => 'form-control', 'data-control'=>'select2']) }}
                </div>
                <span class="px-3">To</span>
                <div class="d-inline-block">
                    {{ Form::select('endTimes['.$day.'][]', getSchedulesTimingSlot(), $times['end_time'],['class' => 'form-control', 'data-control'=>'select2','disabled'=>false]) }}
                </div>
